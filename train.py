...
def get_arg_parser():
    ...
    parser.add_argument('--mlp_hiddens', default='[50, 50]', help="Hidden layers for MLP", dest="mlp_hiddens")
    ...
    parser.add_argument('--exp_eps_segments', default='[(0, 1),(10000, 1),(30000, 0.1)], 0', type=str, help="Segments for the piecewise schedule of the greedy exploration's epsilon", dest="exp_eps_segments")
    ...
    parser.add_argument("--pre_train_steps", type=int, default=int(1000), help="If demo==True, number of steps to learn from demo transitions alone; If demo==False, number of steps to greedily explore the environment before starting training")
