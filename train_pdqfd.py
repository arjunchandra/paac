...
def get_arg_parser():
    ...
    parser.add_argument("--demo_trans_size", type=int, default=int(8000), help="number of demo transitions")
    ...
    parser.add_argument('--exp_epsilon', default=0.02, type=float, help="Epsilon for epsilon greedy exploration", dest="exp_epsilon")
